...
public class IndexBottomAdpater extends BaseAdapter {
    ...
    public IndexBottomAdpater(Context context, List<GoodsListInfo.ResultBean.GoodsListBean> goodsListInfo) {
