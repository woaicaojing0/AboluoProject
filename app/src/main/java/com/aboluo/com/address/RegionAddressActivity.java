...
public class RegionAddressActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choose_address.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(RegionAddressActivity.this,AddAddressActivity.class);
                int regionid = provinceBean.getResult().getCounryAreaList().get(position).getId();
                intent.putExtra("id",regionid);
                intent.putExtra("name",cityName+" "+provinceBean.getResult().getCounryAreaList().get(position).getAreaName().toString());
                intent.putExtra("allid",allid+";"+regionid);
    ...
    private void initdata() {
        ...
        stringRequest = new StringRequest(Request.Method.POST, url + "/api/CountryArea/ReceiveRegionList", new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("ParentId", String.valueOf(cityId));
                return map;
            }
        };
