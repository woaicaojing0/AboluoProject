...
public class AssessmentFragment extends Fragment implements View.OnClickListener{
    ...
    private void init() {
        context = AssessmentFragment.this.getContext();
            ...
            public void onResponse(String response) {
                ...
                if (searchOrderBean.isIsSuccess()) {
                    ...
                    {}else {
                        ...
                        allOrderAdapter.setEvaluateOrderOnClickListener(AssessmentFragment.this);
        ...
        switch (key) {
            ...
            case R.id.content_view: //点击添加数量按钮，执行相应的处理
                ...
                if (tag != null && tag instanceof Integer) { //解决问题：如何知道你点击的按钮是哪一个列表项中的，通过Tag的position
                    ...
                    Intent intent = new Intent(AssessmentFragment.this.getActivity(), OrderDetailActivity.class);
            ...
            case R.id.txt_evaluate:
                if (tag != null && tag instanceof Integer) { //解决问题：如何知道你点击的按钮是哪一个列表项中的，通过Tag的position
                    final int position = (Integer) tag;
                    Intent intent = new Intent(AssessmentFragment.this.getContext(), OrderDetailActivity.class);
                    intent.putExtra("orderid", orderBean.getResult().get(position).getOrderId());
                    startActivity(intent);
                }
                break;
